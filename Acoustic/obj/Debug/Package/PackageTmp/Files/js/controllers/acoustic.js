app.controller("AcousticCtrl", function ($scope, $timeout, $switch, $audio, $lexicon) {
    ...
    $scope.selectGlass = function (glass) {
        ...
        onSetupInners = function () {
            ...
            activeIndex = 0;
            maxIndex = parseInt(23 * (100 - $scope.glass.reductionPercentage) / 100);
            minIndex = 0;
        ...
        onPercentage = function () {
            ...
            $audio.current.volume((100 - $scope.glass.reductionPercentage) / 100);
    ...
    var activeIndex, minIndex, maxIndex;
    var delay;
    var upTo, downTo;
    ...
    var deactivationFinished = function () {

        upTo = randInt(minIndex, maxIndex);

        activateUpTo(upTo);

    };

    var activationFinished = function () {
        ...
        if (swithcing) {
            ...
            downTo = randInt(minIndex, maxIndex);

            deactivateDownTo(downTo);

        }

    };

    var deactivateDownTo = function (index) {

        waves[activeIndex].deactivate();
    ...
    var activateUpTo = function (index) {

        waves[activeIndex].activate();
